...
public class Equator {
    ...
    private final int TOTAL_SCROLLS_TECHSPECS = 2;
    ...
    public void captureScreens() throws Exception {
        ...
        captureAvikScreen("DemoModeExperiencesLight_Equator_Camera");
        mainPage.nextExperienceCard();
        captureAvikScreen("DemoModeExperiencesLight_Equator_Battery");
        mainPage.nextExperienceCard();
        captureAvikScreen("DemoModeExperiencesLight_Equator_Durability");
