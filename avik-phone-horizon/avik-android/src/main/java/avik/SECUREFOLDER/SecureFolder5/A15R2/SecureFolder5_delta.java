...
public class SecureFolder5_delta {
    ...
    AvikScreenshotAction SecureFolder_ActivateSecureFolderRecovery_LoginNow_Dialog = new AndroidAvikScreenshotAction("SecureFolder_ActivateSecureFolderRecovery_LoginNow_Dialog", true);

    AvikScreenshotAction SecureFolder_RecoverAccess_VerifyWithMotoAccount_Dialog = new AndroidAvikScreenshotAction( "SecureFolder_RecoverAccess_VerifyWithMotoAccount_Dialog", true);
    ...
    public void addApp() throws Exception {
        ...
        /*
            Remove all apps from home and hotseat
            add recorder to hotseat
            secure folder pin = 1111
        */
        ...
        mDevice.wait(Until.findObject(By.res("com.android.systemui:id/lockPassword")), Constants.TEN_SECONDS).setText("1111");
        mDevice.pressEnter();
    ...
    public void uninstallOriginalApp() throws Exception {
        ...
        /*
C           Remove all apps from home and hotseat
            add facebook to hotseat
        */
    ...
    private void loginDialog() throws Exception{
        ...
        //TODO: FIX BELOW
        mSettings.openMoreNetworkSettingsScreen();
        mUtility.createScrollable().scrollTextIntoView(mFolder.getAppName());
        mDevice.wait(Until.findObject(By.text(mFolder.getAppName())), Constants.FIVE_SECONDS).click();

        mUtility.sleep(Constants.THREE_SECONDS);
        mDevice.findObject(By.clazz(ScrollView.class)).getChildren().get(2).click();
        mDevice.wait(Until.findObject(By.res(Pattern.compile(".*:id/lockPassword"))), Constants.TEN_SECONDS).setText("1111");
        mDevice.pressEnter();

        String BtnText = mUtility.getResourceByPackAndStringKey(mFolder.PACKAGE_NAME, "password_reset_requirements_dialog_moto_account_confirm");

        mDevice.wait(Until.findObject(By.text(BtnText)), Constants.FIVE_SECONDS);
        mUtility.sleep(Constants.THREE_SECONDS);
        mUtility.takeAvikScreenshotWithFlag(SecureFolder_ActivateSecureFolderRecovery_LoginNow_Dialog);
