...
public class PradoNA {
    ...
    private final String MODEL_NAME = "PradoNA";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_PradoNA_Design");
        ...
        takeScreenshot("DemoModeExperiences_PradoNA_Design_Curved");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_PradoNA_Design_Pantone");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_PradoNA_Design_Durability");

        CameraPage cameraPage = designPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_PradoNA_Camera");
        ...
        takeScreenshot("DemoModeExperiences_PradoNA_Camera_Stunning");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_PradoNA_Camera_Enhancement");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_PradoNA_Camera_Ultra");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_PradoNA_Camera_Smoother");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_PradoNA_Camera_Validated");

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_PradoNA_MotoAI");
