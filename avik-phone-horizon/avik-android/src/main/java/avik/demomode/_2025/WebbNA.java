...
public class WebbNA {
    ...
    private final String MODEL_NAME = "WebbNA";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_WebbNA_Display");
        if (true) {
        ...
        takeScreenshot("DemoModeExperiences_WebbNA_Display_Iconic");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Display_Access");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Display_Pose");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Display_Protected");

        CameraPage cameraPage = displayPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_WebbNA_Camera");
        ...
        takeScreenshot("DemoModeExperiences_WebbNA_Camera_Sharp");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Camera_Selfies");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Camera_Record");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Camera_PhotoBooth");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbNA_Camera_UltraHDR");

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_WebbNA_MotoAI");
