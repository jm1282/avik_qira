...
public class EquatorEMEA {
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_Equator_EMEA_Battery");
        ...
        specsPage.captureSpecs(avikHandler, "Equator_EMEA", TOTAL_SCROLLS_TECHSPECS);

        DisclaimerPage disclaimerPage = specsPage.openDisclaimers();
        disclaimerPage.captureDisclaimers(avikHandler, "Equator_EMEA", TOTAL_SCROLLS_DISCLAIMERS);
    }
