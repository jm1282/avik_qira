...
public class WebbSE {
    ...
    private final String MODEL_NAME = "WebbSE";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_WebbSE_Design");
        ...
        takeScreenshot("DemoModeExperiences_WebbSE_Design_Infused");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbSE_Design_Iconic");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbSE_Design_Access");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbSE_Design_Protected");

        CameraPage cameraPage = designPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_WebbSE_Camera");
        ...
        takeScreenshot("DemoModeExperiences_WebbSE_Camera_Sharp");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbSE_Camera_Selfies");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbSE_Camera_Record");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_WebbSE_Camera_PhotoBooth");

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_WebbSE_MotoAI");
        ...
        specsPage.captureSpecs(avikHandler, "WebbSE_EMEA", TOTAL_SCROLLS_TECHSPECS);
