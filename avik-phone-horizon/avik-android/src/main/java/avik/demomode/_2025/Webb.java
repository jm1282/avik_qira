...
public class Webb {
    ...
    private final String MODEL_NAME = "Webb";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_Webb_Display");
        ...
        takeScreenshot("DemoModeExperiences_Webb_Display_Iconic");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Webb_Display_Access");
        displayPage.nextExperienceCard();
        // takeScreenshot("DemoModeExperiences_Webb_Display_Pose");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Webb_Display_Protected");

        CameraPage cameraPage = displayPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_Webb_Camera");
        ...
        takeScreenshot("DemoModeExperiences_Webb_Camera_Sharp");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Webb_Camera_Selfies");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Webb_Camera_Record");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Webb_Camera_PhotoBooth");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Webb_Camera_UltraHDR");

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_Webb_MotoAI");
        ...
        specsPage.captureSpecs(avikHandler, "Webb_EMEA", TOTAL_SCROLLS_TECHSPECS);
