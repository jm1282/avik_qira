...
public class Milos {
    ...
    private final String MODEL_NAME = "Milos";
    ...
    public void captureScreens() throws Exception {
        ...
        cameraPage.openMenu();
        takeScreenshot("DemoModeExperiences_Milos_Menu");
        cameraPage.goBack();

        takeScreenshot("DemoModeExperiences_Milos_Camera");
        ...
        takeScreenshot("DemoModeExperiences_Milos_Camera_50MP");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Milos_Camera_Pantone");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Milos_Camera_Ultrawide");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Milos_Camera_Lightsensor");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Milos_Camera_Selfie");

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_Milos_MotoAI");
        ...
        takeScreenshot("DemoModeExperiences_Milos_Design");
        ...
        takeScreenshot("DemoModeExperiences_Milos_Design_Build");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Milos_Design_Durability");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Milos_Design_Underwater");
