...
public class HoustonNA {
    ...
    private final String MODEL_NAME = "HoustonNA";
    ...
    public void captureScreens() throws Exception {
        ...
        cameraPage.openMenu();
        takeScreenshot("DemoModeExperiences_HoustonNA_Menu");
        cameraPage.goBack();

        takeScreenshot("DemoModeExperiences_HoustonNA_Stylus");
        BaseDialog cameraDialog = cameraPage.openDialog();
        cameraDialog.captureScroll(avikHandler, MODEL_NAME, "Stylus");
        cameraDialog.closeDialog();
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Stylus_Flow");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Stylus_Note");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Stylus_Mark");

        DesignPage designPage = cameraPage.nextExperience(DesignPage.class);
        takeScreenshot("DemoModeExperiences_HoustonNA_Design");
        BaseDialog designDialog = cameraPage.openDialog();
        designDialog.captureScroll(avikHandler, MODEL_NAME, "Design");
        designDialog.closeDialog();
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Design_Striking");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Design_Advanced");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Design_Certified");

        EntertainmentPage entertainmentPage = designPage.nextExperience(EntertainmentPage.class);
        takeScreenshot("DemoModeExperiences_HoustonNA_Entertainment");
        ...
        takeScreenshot("DemoModeExperiences_HoustonNA_Entertainment_Display");
        entertainmentPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_HoustonNA_Entertainment_Sound");


        SpecsPage specsPage = designPage.nextExperience(SpecsPage.class);
