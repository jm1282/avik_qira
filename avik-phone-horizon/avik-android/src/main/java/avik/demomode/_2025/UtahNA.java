...
public class UtahNA {
    ...
    private final String MODEL_NAME = "UtahNA";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_UtahNA_Display");
        ...
        takeScreenshot("DemoModeExperiences_UtahNA_Display_Clearly");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_UtahNA_Display_Screen");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_UtahNA_Display_HD");

        CameraPage cameraPage = displayPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_UtahNA_Camera");
        ...
        takeScreenshot("DemoModeExperiences_UtahNA_Camera_Selfie");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_UtahNA_Camera_Smooth");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_UtahNA_Camera_Snap");
        cameraPage.nextExperienceCard();

        PerformancePage performancePage = cameraPage.nextExperience(PerformancePage.class);
        takeScreenshot("DemoModeExperiences_UtahNA_Performance");
        ...
        takeScreenshot("DemoModeExperiences_UtahNA_Performance_5G");
        performancePage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_UtahNA_Performance_Multitask");
        performancePage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_UtahNA_Performance_Battery");
