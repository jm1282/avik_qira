...
public class Paris {
    ...
    private final String MODEL_NAME = "Paris";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_Paris_Design");
        ...
        takeScreenshot("DemoModeExperiences_Paris_Design_Compact");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Paris_Design_Durability");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Paris_Design_Feel");

        CameraPage cameraPage = designPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_Paris_Camera");
        ...
        takeScreenshot("DemoModeExperiences_Paris_Camera_Perfect");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Paris_Camera_Expand");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Paris_Camera_Portraits");
        cameraPage.nextExperienceCard();

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_Paris_MotoAI");
