...
public class MilosPlus {
    ...
    private final String MODEL_NAME = "MilosPlus";
    ...
    public void captureScreens() throws Exception {
        ...
        takeScreenshot("DemoModeExperiences_MilosPlus_Camera");
        ...
        takeScreenshot("DemoModeExperiences_MilosPlus_Camera_50MP");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_MilosPlus_Camera_Ultrawide");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_MilosPlus_Camera_Zoom");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_MilosPlus_Camera_FrontCamera");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_MilosPlus_Camera_Pantone");

        MotoAIPage motoaiPage = cameraPage.nextExperience(MotoAIPage.class);
        takeScreenshot("DemoModeExperiences_MilosPlus_MotoAI");
        BaseDialog motoaiDialog = cameraPage.openDialog();
        motoaiDialog.captureScroll(avikHandler, MODEL_NAME, "MotoAI");
        motoaiDialog.closeDialog();

        DesignPage designPage = motoaiPage.nextExperience(DesignPage.class);
        takeScreenshot("DemoModeExperiences_MilosPlus_Design");
        ...
        takeScreenshot("DemoModeExperiences_MilosPlus_Design_Build");
        designPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_MilosPlus_Design_Durability");
        // designPage.nextExperienceCard();
        // takeScreenshot("DemoModeExperiences_MilosPlus_Design_Underwater");
