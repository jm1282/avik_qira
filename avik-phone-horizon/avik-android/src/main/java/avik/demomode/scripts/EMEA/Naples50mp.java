...
public class Naples50mp {
    ...
    public void captureScreens() throws Exception {
        ...
        displayDialog.captureScroll(avikHandler, "Naples50MP_EMEA", "Display");
        displayDialog.closeDialog();
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Naples50MP_Display_SuperHD");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Naples50MP_EMEA_Display_AMOLED");
        displayPage.nextExperienceCard();
        ...
        specsPage.captureSpecs(avikHandler, "Naples50MP_EMEA", TOTAL_SCROLLS_TECHSPECS);
