...
public class Lamu {
    ...
    private final String MODEL_NAME = "Lamu";
    ...
    public void captureScreens() throws Exception {
        ...
        // takeScreenshot("DemoModeExperiences_Lamu_Sizzle");
...
//		takeScreenshot("DemoModeExperiences_Lamu_Menu");
//		entertainmentPage.goBack();
        takeScreenshot("DemoModeExperiences_Lamu_Entertainment");
        ...
        takeScreenshot("DemoModeExperiences_Lamu_Entertainment_Life");

        CameraPage cameraPage = entertainmentPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_Lamu_Camera");
        ...
        takeScreenshot("DemoModeExperiences_Lamu_Camera_Main");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Lamu_Camera_UltraWide");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Lamu_Camera_Portrait");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Lamu_Camera_NightVision");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_Lamu_Camera_Selfie");

        BatteryPage batteryPage = cameraPage.nextExperience(BatteryPage.class);
        takeScreenshot("DemoModeExperiences_Lamu_Battery");
        ...
        takeScreenshot("DemoModeExperiences_Lamu_Battery_Longer");
