...
public class GloryJP {
    ...
    private final String MODEL_NAME = "GloryJP";
    ...
    public void captureScreens() throws Exception {
        // takeScreenshot("DemoModeExperiences_GloryJP_Widget");
        HomePage homePage = mDemoMode.callApp();
//		takeScreenshot("DemoModeExperiences_GloryJP_Discover");
        DisplayPage displayPage = homePage.openExperiences(DisplayPage.class);
        displayPage.openMenu();
        takeScreenshot("DemoModeExperiences_GloryJP_Menu");
        displayPage.goBack();
        takeScreenshot("DemoModeExperiences_GloryJP_Display");
        BaseDialog displayDialog = displayPage.openDialog();
        takeScreenshot("DemoModeExperiences_GloryJP_Display_Dialog");
        displayDialog.closeDialog();
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Display_ExternalDisplay");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Display_MadeForMusic");

        FlexViewPage flexViewPage = displayPage.nextExperience(FlexViewPage.class);
        takeScreenshot("DemoModeExperiences_GloryJP_FlexView");
        BaseDialog flexViewDialog = flexViewPage.openDialog();
        takeScreenshot("DemoModeExperiences_GloryJP_FlexView_Dialog");
        flexViewDialog.closeDialog();
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_FlexView_Camcorder");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_FlexView_HandsFree");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_FlexView_DeskDisplay");

        CameraPage cameraPage = flexViewPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_GloryJP_Camera");
        BaseDialog cameraDialog = cameraPage.openDialog();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_Dialog_Scrolling1");
        cameraDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_Dialog_Scrolling2");
        cameraDialog.closeDialog();
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_AdaptiveStabilization");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_Ultrawide");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_Timelapse");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_PhotoBooth");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryJP_Camera_GroupSelfie");
