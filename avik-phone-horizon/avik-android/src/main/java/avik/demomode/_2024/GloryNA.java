...
public class GloryNA {
    ...
    private final String MODEL_NAME = "GloryNA";
    ...
    public void captureScreens() throws Exception {
        // takeScreenshot("DemoModeExperiences_GloryNA_Widget");
        HomePage homePage = mDemoMode.callApp();
        takeScreenshot("DemoModeExperiences_GloryNA_Discover");
        DisplayPage displayPage = homePage.openExperiences(DisplayPage.class);
        displayPage.openMenu();
        takeScreenshot("DemoModeExperiences_GloryNA_Menu");
        displayPage.goBack();
        takeScreenshot("DemoModeExperiences_GloryNA_Display");
        BaseDialog displayDialog = displayPage.openDialog();
        takeScreenshot("DemoModeExperiences_GloryNA_Display_Dialog_Scrolling1");
        displayDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_GloryNA_Display_Dialog_Scrolling2");
        displayDialog.closeDialog();
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Display_ExternalDisplay");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Display_Spotify");

        FlexViewPage flexViewPage = displayPage.nextExperience(FlexViewPage.class);
        takeScreenshot("DemoModeExperiences_GloryNA_FlexView");
        BaseDialog flexViewDialog = flexViewPage.openDialog();
        takeScreenshot("DemoModeExperiences_GloryNA_FlexView_Dialog_Scrolling1");
        flexViewDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_GloryNA_FlexView_Dialog_Scrolling2");
        flexViewDialog.closeDialog();
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_FlexView_Camcorder");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_FlexView_VideoChat");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_FlexView_DeskDisplay");

        CameraPage cameraPage = flexViewPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_GloryNA_Camera");
        BaseDialog cameraDialog = cameraPage.openDialog();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_Dialog_Scrolling1");
        cameraDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_Dialog_Scrolling2");
        cameraDialog.closeDialog();
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_AdaptiveStabilization");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_UltraWide");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_Timelapse");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_PhotoBooth");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_GroupSelfies");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_GloryNA_Camera_TestCamera");
//		CameraT mCameraApp = cameraPage.openTestCamera();
//		takeScreenshot("DemoModeExperiences_GloryNA_Camera_GoBackOverlay");
