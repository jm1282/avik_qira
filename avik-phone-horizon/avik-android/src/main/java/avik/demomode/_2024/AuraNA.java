...
public class AuraNA {
    ...
    private final String MODEL_NAME = "AuraNA";
    ...
    public void captureScreens() throws Exception {
        // takeScreenshot("DemoModeExperiences_AuraNA_Widget");
        HomePage homePage = mDemoMode.callApp();
        takeScreenshot("DemoModeExperiences_AuraNA_Discover");
        DisplayPage displayPage = homePage.openExperiences(DisplayPage.class);
        displayPage.openMenu();
        takeScreenshot("DemoModeExperiences_AuraNA_Menu");
        displayPage.goBack();
        takeScreenshot("DemoModeExperiences_AuraNA_Display");
        BaseDialog displayDialog = displayPage.openDialog();
        takeScreenshot("DemoModeExperiences_AuraNA_Display_Dialog_Scrolling1");
        displayDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_AuraNA_Display_Dialog_Scrolling2");
        displayDialog.closeDialog();
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Display_ExternalDisplay");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Display_MadeForMusic");

        FlexViewPage flexViewPage = displayPage.nextExperience(FlexViewPage.class);
        takeScreenshot("DemoModeExperiences_AuraNA_FlexView");
        BaseDialog flexViewDialog = flexViewPage.openDialog();
        takeScreenshot("DemoModeExperiences_AuraNA_FlexView_Dialog_Scrolling1");
        flexViewDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_AuraNA_FlexView_Dialog_Scrolling2");
        flexViewDialog.closeDialog();
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_FlexView_Camcorder");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_FlexView_HandsFree");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_FlexView_DeskDisplay");

        CameraPage cameraPage = flexViewPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_AuraNA_Camera");
        BaseDialog cameraDialog = cameraPage.openDialog();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_Dialog_Scrolling1");
        cameraDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_Dialog_Scrolling2");
        cameraDialog.closeDialog();
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_TelephotoLens");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_AdaptiveStabilization");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_ActionShot");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_AutoFocus");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_LongExposure");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraNA_Camera_TestCamera");
//		CameraT mCameraApp = cameraPage.openTestCamera();
//		takeScreenshot("DemoModeExperiences_AuraNA_Camera_GoBackOverlay");
//		cameraPage.clickGoBackOverlay();

        // Go Back to Avoid Error when scrolling on TestCamera Page
