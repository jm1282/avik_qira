...
public class AuraROW {
    ...
    private final String MODEL_NAME = "AuraROW";
    ...
    public void captureScreens() throws Exception {
        takeScreenshot("DemoModeExperiences_AuraROW_Widget");
        HomePage homePage = mDemoMode.callApp();
        takeScreenshot("DemoModeExperiences_AuraROW_Discover");
        DisplayPage displayPage = homePage.openExperiences(DisplayPage.class);
        displayPage.openMenu();
        takeScreenshot("DemoModeExperiences_AuraROW_Menu");
        displayPage.goBack();
        takeScreenshot("DemoModeExperiences_AuraROW_Display");
        BaseDialog displayDialog = displayPage.openDialog();
        takeScreenshot("DemoModeExperiences_AuraROW_Display_Dialog_Scrolling1");
        displayDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_AuraROW_Display_Dialog_Scrolling2");
        displayDialog.closeDialog();
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Display_ExternalDisplay");
        displayPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Display_MadeForMusic");

        FlexViewPage flexViewPage = displayPage.nextExperience(FlexViewPage.class);
        takeScreenshot("DemoModeExperiences_AuraROW_FlexView");
        BaseDialog flexViewDialog = flexViewPage.openDialog();
        takeScreenshot("DemoModeExperiences_AuraROW_FlexView_Dialog_Scrolling1");
        flexViewDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_AuraROW_FlexView_Dialog_Scrolling2");
        flexViewDialog.closeDialog();
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_FlexView_Camcorder");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_FlexView_HandsFree");
        flexViewPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_FlexView_DeskDisplay");

        CameraPage cameraPage = flexViewPage.nextExperience(CameraPage.class);
        takeScreenshot("DemoModeExperiences_AuraROW_Camera");
        BaseDialog cameraDialog = cameraPage.openDialog();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_Dialog_Scrolling1");
        cameraDialog.scrollDialog();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_Dialog_Scrolling2");
        cameraDialog.closeDialog();
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_TelephotoLens");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_AdaptiveStabilization");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_ActionShot");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_Portrait");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_LongExposure");
        cameraPage.nextExperienceCard();
        takeScreenshot("DemoModeExperiences_AuraROW_Camera_TestCamera");
//		CameraT mCameraApp = cameraPage.openTestCamera();
//		takeScreenshot("DemoModeExperiences_AuraROW_Camera_GoBackOverlay");
