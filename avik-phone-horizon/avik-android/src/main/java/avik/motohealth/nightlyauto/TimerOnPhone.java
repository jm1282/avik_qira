...
public class TimerOnPhone {
    ...
    public void captureOfTimer() throws Exception {
        ...
        mUtil.takeAvikScreenshot("MotoHealth_AddTimer_MultiTimers_None");
        mUtil.clickByObj("","com.motorola.watch:id/btn_timer",0);// Multi-timers page to begin
        mUtil.takeAvikScreenshot("MotoHealth_AddTimer_Main");
        ...
        mUtil.takeAvikScreenshot("MotoHealth_AddTimer_TimerDetails_Dialog");
        uiDevice.findObject(By.res("com.motorola.watch:id/et_timer_name")).setText("aaaa");
        mUtil.waitFor10S(30,"Waiting for select the time 1, 1, 1");
//        mUtil.clickByObj("set","com.motorola.watch:id/bt_done",0);
//        mUtil.clickByObj("Add timer","com.motorola.watch:id/tv_timer_name",0);
//        uiDevice.findObject(By.res("com.motorola.watch:id/et_timer_name")).setText("aviktimer2");
//        mUtil.waitFor10S(10,"Waiting for select the time 1, 1, 0");
//        mUtil.clickByObj("set","com.motorola.watch:id/bt_done",0);
//        mUtil.clickByObj("Add timer","com.motorola.watch:id/tv_timer_name",0);
//        uiDevice.findObject(By.res("com.motorola.watch:id/et_timer_name")).setText("avikthird3");
//        mUtil.waitFor10S(10,"Waiting for select the time 1, 0, 0");
//        mUtil.clickByObj("set","com.motorola.watch:id/bt_done",0);
        mUtil.takeAvikScreenshot("MotoHealth_AddTimer_ThreeTimesDone");
        mUtil.clickByObj("Save","com.motorola.watch:id/btn_timer",0);
        mUtil.takeAvikScreenshot("MotoHealth_AddTimer_Save_Dialog");
        mUtil.clickByObj("save","com.motorola.watch:id/bt_done",0);
        mUtil.takeAvikScreenshotToast("MotoHealth_AddTimer_Save_Toast");
        mUtil.sleep(1000);
        ...
        mUtil.takeAvikScreenshot("MotoHealth_AddTimer_MultiTimers_Delete");
        mUtil.clickByObj("Delete btn","com.motorola.watch:id/btn_timer",0);
        mUtil.takeAvikScreenshotToast("MotoHealth_AddTimer_MultiTimers_Toast");
    }
    @Before
