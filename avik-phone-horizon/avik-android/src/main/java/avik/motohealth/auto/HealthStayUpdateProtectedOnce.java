...
public class HealthStayUpdateProtectedOnce {
    @Rule
    ...
    public void captureOfHealth() throws Exception {
        mUtil.waitFor10S(10,"Wait for notification");
        mUtil.takeAvikScreenshot("MotoHealth_NoneNotification_StayUpdateProtected");
