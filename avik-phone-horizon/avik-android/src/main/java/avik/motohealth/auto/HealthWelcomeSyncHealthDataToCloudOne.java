...
public class HealthWelcomeSyncHealthDataToCloudOne {
    @Rule
    ...
    public void captureOfHealth() throws Exception {
        while (!uiDevice.hasObject(By.res("com.motorola.watch:id/tip_list"))) {
          mUtil.waitFor10S(10,"Manual to show the smart connect page.");
        }
        mUtil.waitFor10S(5,"waiting for the notification disappear.");
        mUtil.takeAvikScreenshot("MotoHealth_Welcome_SyncHealthDataToCloud");
    }
