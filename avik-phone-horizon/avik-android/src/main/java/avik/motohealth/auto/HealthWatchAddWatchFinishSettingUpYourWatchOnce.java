...
public class HealthWatchAddWatchFinishSettingUpYourWatchOnce {
    @Rule
...
mUtil.isExistResuorceId("com.motorola.watch:id/btn_agree");
mUtil.sleep(5000);
 mUtil.takeAvikScreenshot("MotoHealth_Devices_FinishSettingsUpYourWatch");
    }
