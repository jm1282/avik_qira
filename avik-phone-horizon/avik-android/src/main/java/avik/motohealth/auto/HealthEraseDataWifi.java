...
public class HealthEraseDataWifi {
    @Rule
...
//        mUtil.takeAvikScreenshot("MotoHealth_Settings_SyncDataToCloud_OnWiFi");
        ...
        mUtil.takeAvikScreenshotToast("MotoHealth_Settings_EraseCloudData_ToastWifi");
        mUtil.sleep(2000);
        mUtil.takeAvikScreenshot("MotoHealth_Settings_EraseCloudData_SuccessfullyWifi");
    }
