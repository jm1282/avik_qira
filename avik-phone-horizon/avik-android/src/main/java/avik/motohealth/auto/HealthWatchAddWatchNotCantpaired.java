...
public class HealthWatchAddWatchNotCantpaired {
    @Rule
    ...
    public void captureOfHealth() throws Exception {
        ...
        mUtil.clickByObj("","com.motorola.watch:id/ok_button",0);
       mUtil.clickByObj("","com.motorola.watch:id/name",0);
        mUtil.takeAvikScreenshot("MotoHealth_AddWatch_CantPaired");
       mUtil.clickByObj("OK","com.motorola.watch:id/bt_done",0);
    }
