...
public class HealthWelcomeSmartConnectDashboardOne {
    @Rule
    ...
    public void captureOfHealth() throws Exception {
        while (!uiDevice.hasObject(By.res("com.motorola.watch:id/confirm"))) {
          mUtil.waitFor10S(10,"Manual to show the smart connect page.");
        }
        mUtil.waitFor10S(5,"waiting for the notification disappear.");
        mUtil.takeAvikScreenshot("MotoHealth_Welcome_SmartConnectDashboard");
    }
