...
public class HealthWatchAddWatchSteps2Once {
    @Rule
    ...
    public void captureOfHealth() throws Exception {
        mUtil.isExistResuorceId("com.motorola.watch:id/btn_skip");
        mUtil.waitFor10S(5,"=====Remove notification");
        mUtil.takeAvikScreenshot("MotoHealth_Devices_AddDevice_Step2");
    }
