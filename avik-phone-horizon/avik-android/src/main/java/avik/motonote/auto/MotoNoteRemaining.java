...
public class MotoNoteRemaining {
    @Rule
...
//
//
        String stylusWriting = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "stylus_settings_global_handwriting_title");
        mDevice.wait(Until.findObject(By.text(stylusWriting)), Constants.THREE_SECONDS).getParent().click();
        mUtils.sleep(Constants.THREE_SECONDS);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusWriting_Tutorial1");
        mUtils.sleep(Constants.HALF_SECOND);
        mObjectUtils.runCommand("input swipe 1080 1500 200 1500");
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusWriting_Tutorial2");
        mUtils.sleep(Constants.HALF_SECOND);
        mObjectUtils.runCommand("input swipe 1080 1500 200 1500");
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusWriting_Tutorial3");
        mUtils.sleep(Constants.HALF_SECOND);
        mObjectUtils.runCommand("input swipe 1080 1500 200 1500");
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusWriting_Tutorial4");
        mUtils.sleep(Constants.HALF_SECOND);
        mObjectUtils.runCommand("input swipe 1080 1500 200 1500");
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.wait(Until.findObject(By.res("android:id/switch_widget")), Constants.FIVE_SECONDS).click();
        mUtils.sleep(Constants.TWO_SECONDS);
        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusWriting_Tutorial5");
        mUtils.sleep(Constants.HALF_SECOND);
        ...
        String whenLocked = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "pos_device_locked");
        mDevice.wait(Until.findObject(By.text(whenLocked)), Constants.THREE_SECONDS).getParent().click();
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_WhenDeviceIsLocked_Dialog");
        mUtils.sleep(Constants.HALF_SECOND);
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/cancel_button")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        String whenUnlocked = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "pos_device_unlocked");
        mDevice.wait(Until.findObject(By.text(whenUnlocked)), Constants.THREE_SECONDS).getParent().click();
        mUtils.sleep(Constants.THREE_SECONDS);
        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_Shortcuts_Scrolling1");
        mUtils.sleep(Constants.HALF_SECOND);

        mObjectUtils.createScrollablebyResourceID("com.motorola.stylus:id/added_shortcuts").setAsHorizontalList().scrollForward();
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_Shortcuts_Scrolling2");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/sub_switch")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_Shortcuts_Off");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/sub_switch")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

//        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/shortcuts_settings")), Constants.THREE_SECONDS).click();
        mDevice.click(1020, 140);
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_Shortcuts_PanelStyle_Dialog");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/cancel_button")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        String gifMaker = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "gif_maker");
        mDevice.wait(Until.findObject(By.text(gifMaker)), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_Shortcuts_YouCanAddUpTo6_Toast");
        mUtils.sleep(Constants.THREE_SECONDS);

        mDevice.pressBack();
        mUtils.sleep(Constants.TWO_SECONDS);

        String outOfCase = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "settings_loss_reminder");
        mDevice.wait(Until.findObject(By.text(outOfCase)), Constants.THREE_SECONDS).getParent().click();
        mUtils.sleep(Constants.TWO_SECONDS);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusOutOfCase_Dialog");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/cancel_button")), Constants.FIVE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mObjectUtils.createScrollable().scrollForward();
        mUtils.sleep(Constants.ONE_SECOND);

        String lastKnownLocation = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "settings_record_last_usage");
        mDevice.wait(Until.findObject(By.text(lastKnownLocation)), Constants.SEVEN_SECONDS).getParent().getParent().getParent().getChildren().get(2).getChildren().get(0).click();
        mUtils.sleep(Constants.ONE_SECOND);
//        mDevice.wait(Until.findObject(By.clazz("android.widget.LinearLayout").hasDescendant(By.text(lastKnownLocation))), Constants.THREE_SECONDS)).findObject(By.res("com.motorola.stylus:id/switchWidget")).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_LastKnownLocation_PermissionRequired_Dialog");
        mUtils.sleep(Constants.HALF_SECOND);

        mObjectUtils.skipAndroidButton2();
        mUtils.sleep(Constants.ONE_SECOND);

        String stylusTip = mObjectUtils.getResourceByPackAndStringKey("com.motorola.stylus", "settings_learn_more");
        mDevice.wait(Until.findObject(By.text(stylusTip)), Constants.THREE_SECONDS).getParent().click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusTips1");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/next")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusTips2");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/next")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.takeAvikScreenshot("MotoStylus_Settings_StylusSettings_StylusTips3");
        mUtils.sleep(Constants.HALF_SECOND);
        ...
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/fab")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/endIcon")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);
...
//        mDevice.findObject(mStylus.recyclerView).getChildren().get(0).click();
        ...
        mDevice.wait(Until.findObject(mStylus.recyclerView), Constants.THREE_SECONDS).getChildren().get(6).click();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/btn_positive")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.wait(Until.hasObject(By.res("com.motorola.stylus:id/bottom_sheet")), Constants.FIFTEEN_SECONDS);
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.takeAvikScreenshot("MotoStylus_MergedNote_WantASummary");
        mUtils.sleep(Constants.HALF_SECOND);

        mDevice.pressBack();
        mUtils.sleep(Constants.ONE_SECOND);

        mDevice.wait(Until.findObject(mStylus.recyclerView), Constants.THREE_SECONDS).getChildren().get(3).click();
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/sketch_to_image")), Constants.THREE_SECONDS).click();
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.wait(Until.hasObject(By.res("com.motorola.stylus:id/bottom_sheet")), Constants.FIFTEEN_SECONDS);
        mUtils.sleep(Constants.ONE_SECOND);
        mDevice.takeAvikScreenshot("MotoStylus_TextNote_UnlockSketchToImage");
//            mUtility.takeAvikScreenshotWithFlag(MotoStylus_TextNote_UnlockSketchToImage);
        mUtils.sleep(Constants.HALF_SECOND);
        mDevice.pressBack();
        mUtils.sleep(Constants.TWO_SECONDS);
//
