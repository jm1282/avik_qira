...
public class MotoNoteA16R2_StylusUrusNew {
    @Rule
    ...
    //Ter uma nota criada
    private AvikScreenshotAction MotoStylus_Main_MoreOptions_Tip = new AndroidAvikScreenshotAction("MotoStylus_Main_MoreOptions_Tip", true);
    private AvikScreenshotAction MotoStylus_Note_NoteTitle = new AndroidAvikScreenshotAction("MotoStylus_Note_NoteTitle", true);
    private AvikScreenshotAction MotoStylus_Note_Options_PinToStylusToolbar = new AndroidAvikScreenshotAction("MotoStylus_Note_Options_PinToStylusToolbar", true); //
    private AvikScreenshotAction MotoStylus_Note_Options_UnpinFromStylusToolbar = new AndroidAvikScreenshotAction("MotoStylus_Note_Options_UnpinFromStylusToolbar", true);
    private AvikScreenshotAction MotoStylus_Settings_SmartPen_Scrolling1 = new AndroidAvikScreenshotAction("MotoStylus_Settings_SmartPen_Scrolling1", true);
    private AvikScreenshotAction MotoStylus_Settings_SmartPen_Scrolling2 = new AndroidAvikScreenshotAction("MotoStylus_Settings_SmartPen_Scrolling2", true);
...
//        mStylus.clearApp();
    ...
    public void captureScreensOfMotoNoteMain() throws Exception {
        ...
        mStylus.openApp();
//NOTA PREVIAMENTE CRIADA COM O NOME AVIK
        mDevice.wait(Until.hasObject(By.res("com.motorola.stylus:id/note_item_content")), Constants.TEN_SECONDS);
        mUtility.sleep(Constants.ONE_SECOND);
        ...
        mUtility.sleep(Constants.ONE_SECOND);
        mUtility.takeAvikScreenshotWithFlag(MotoStylus_Main_MoreOptions_Tip);
        mUtility.sleep(Constants.HALF_SECOND);
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/note_item_content")), Constants.TEN_SECONDS).click();
        mUtility.sleep(Constants.ONE_SECOND);
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/title")), Constants.THREE_SECONDS).click();
        mUtility.sleep(Constants.ONE_SECOND);
        mUtility.takeAvikScreenshotWithFlag(MotoStylus_Note_NoteTitle);
        mUtility.sleep(Constants.HALF_SECOND);
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/close_btn")), Constants.THREE_SECONDS).click();
        mUtility.sleep(Constants.ONE_SECOND);
        ...
        mUtility.takeAvikScreenshotWithFlag(MotoStylus_Note_Options_PinToStylusToolbar);
        mUtility.sleep(Constants.HALF_SECOND);
        mDevice.findObject(By.res("com.motorola.stylus:id/recycler_view")).getChildren().get(2).click();
        mUtility.sleep(Constants.THREE_SECONDS);
        mUtility.sleep(Constants.HALF_SECOND);
        mDevice.wait(Until.findObject(By.res("com.motorola.stylus:id/container_end")), Constants.THREE_SECONDS).getChildren().get(2).click();
        mUtility.sleep(Constants.TWO_SECONDS);
        mUtility.takeAvikScreenshotWithFlag(MotoStylus_Note_Options_UnpinFromStylusToolbar);
        mUtility.sleep(Constants.HALF_SECOND);
        mDevice.findObject(By.res("com.motorola.stylus:id/recycler_view")).getChildren().get(2).click();
        mUtility.sleep(Constants.THREE_SECONDS);
...
//    }
    ...
    public void captureSettingsActivePen() throws Exception {
        mUtility.runShellCommand("am start -n com.motorola.stylus/com.motorola.stylus.settings.activity.NoteSettingActivity");
        mUtility.sleep(Constants.THREE_SECONDS);
        mUtility.takeAvikScreenshotWithFlag(MotoStylus_Settings_SmartPen_Scrolling1);
        mUtility.sleep(Constants.HALF_SECOND);
        mUtil.swipeFromCenterToTop();
        mUtility.sleep(Constants.TWO_SECONDS);
        mUtility.takeAvikScreenshotWithFlag(MotoStylus_Settings_SmartPen_Scrolling2);
        mUtility.sleep(Constants.HALF_SECOND);
